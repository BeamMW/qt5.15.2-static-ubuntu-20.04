...
QT.gui_private.enabled_features = xkbcommon xkbcommon-x11 xcb egl egl_x11 eglfs xlib xcb-xlib eglfs_x11 evdev freetype system-freetype fontconfig gif harfbuzz ico imageio-text-loading jpeg linuxfb multiprocess png raster-64bit system-xcb-xinput tuiotouch vkgen vnc xcb-egl-plugin xcb-glx-plugin xcb-glx xcb-sm
